...
class CharacterLLM:
    ...
    async def generate_memory(self, character_data: Dict[str, Any], memory_type: str) -> Dict[str, Any]:
        ...
        "behavior_impact": {
            "habit_formed": "每次提交代码前会做三重检查",
            "attitude_change": "从抵触加班变为重视问题解决",
            "response_pattern": "遇到突发故障会先深呼吸再拆解问题"
        },
        "trigger_system": {
            "sensory": ["键盘连续敲击30分钟以上", "闻到速溶咖啡的焦味"],
            "contextual": ["项目上线前的最后测试", "独自加班到深夜时"],
            "emotional": ["感到焦虑时", "面临关键决策时"]
        },
        "memory_distortion": {
            "exaggerated": "自己当时坚持的时间比实际更长",
            "downplayed": "忽略了同事暗中提供的技术提示",
            "reason": "强化自我能力认可的心理需求"
        }
        }}
